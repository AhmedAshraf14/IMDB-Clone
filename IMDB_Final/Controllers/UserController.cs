...
namespace IMDB_Final.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult Login(string User)
        {
         ...
         var usr = db.Users.Where(u => u.UserName == User).FirstOrDefault();
        ...
        public ActionResult Search(string SearchString)
        {
            int i = 0;
            UserView userView = new UserView();
            var actor = db.Actors.Where(x => x.FirstName.ToLower() == SearchString.ToLower() || x.LastName.ToLower() == SearchString.ToLower()).ToList();
            ...
            var Movie = db.Movies.Where(x => x.MovieName.ToLower() == SearchString.ToLower()).ToList();
            ...
            var Director = db.Directors.Where(x => x.FirstName.ToLower() == SearchString.ToLower() ||  x.LastName.ToLower() == SearchString.ToLower()).ToList();
